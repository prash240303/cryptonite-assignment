...
const ExplorePage: React.FC = () => {
  ...
  if (status === 'loading') {
    return <div className={`p-3 border-[2px] max-w-6xl mx-auto mt-12 rounded-lg theme-transition ${theme === 'dark' ? "bg-gray-950 border-gray-600" : "bg-gray-100 border-gray-400"}`}>Loading...</div>;
  }

  if (status === 'failed') {
    return <div className={`p-3 border-[2px] max-w-6xl mx-auto mt-12 rounded-lg theme-transition ${theme === 'dark' ? "bg-gray-950 border-gray-600" : "bg-gray-100 border-gray-400"}`}>Error: {error}</div>;
  }

  return (
    <div className={`p-3 text-xs max-w-5xl mx-auto mt-12 border-[2px] rounded-lg theme-transition ${theme === 'dark' ? "bg-gray-950 border-gray-600" : "bg-gray-100 border-gray-400"}`}>
